...
New / Low-Review Listings
Established Mainstream
Long-Stay Listings
Low-Rated Listings
Professional Hosts
Premium Large Properties
...
so the README above uses those exact names. That's intentional.

After you paste/save the README, run:

git add README.md
git commit -m "Add professional project documentation"
git push

Then refresh GitHub and your repository will have the complete project documentation.

just give me a copy option all at once to paste it and code after that

Copy this entire block at once into your README.md:
...
The repository contains the final analytical clustering dataset:
